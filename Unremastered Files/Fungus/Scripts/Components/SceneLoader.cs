...
namespace Fungus
{
    ...
    public class SceneLoader : MonoBehaviour
    {
        ...
        protected LoadSceneMode eLoadMode; 
...
#else
            SceneManager.LoadScene(sceneToLoad, eLoadMode);
#endif
        ...
        public static void LoadScene(string _sceneToLoad, Texture2D _loadingTexture, LoadSceneMode _loadMode)
        {
            ...
            sceneLoader.eLoadMode = _loadMode;
        }
