...
namespace Fungus
{
    ...
    public class SpawnObject : Command
    {
        ...
        [SerializeField] protected BooleanData _changePosition = new BooleanData(true);
