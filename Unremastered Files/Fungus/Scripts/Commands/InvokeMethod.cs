...
namespace Fungus
{
    ...
    public class InvokeMethod : Command
    {
        ...
        protected virtual void Awake()
        {
            ...
            if (objComponent == null)
            {
                if (targetObject == null)
                    Debug.LogError("The targetObject of InvokeMethod in block " + ParentBlock.name + " in flowchart " + GetFlowchart().name + " is null.");
        ...
        public override void OnEnter()
        {
            ...
            {
                Debug.LogError("Error: " + ex.Message + " " + ParentBlock.BlockName + " " + description);
            }      
        }
        ...
        public override string GetSummary()
        {
            ...
            return targetObject.name + "." + targetComponentText;
        }
